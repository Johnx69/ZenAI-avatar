...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--save_every_epochs",
        type=int,
        default=10,              # ← change if you want a different default
        help=(
            "Save a full checkpoint every N epochs. "
            "Set to 0 to disable epoch-based saving (step-based logic is still honoured)."
        ),
    )
